    ...
    public partial class CowHealth : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string Query = "INSERT INTO HealthTbl (CowId, Cowname, RepDate, Event, Diagnosis, Treatment, Cost, VetName) " +
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string Query = "delete from HealthTbl where CowId=" + key + ";";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string Query = "update HealthTbl set CowId = '" + CowIdCb.SelectedValue.ToString() + "' , CowName = '" + CowNameTb.Text + "' , RepDate = '" + RepDateTb.Text + "' , Event = '" + EventTb.Text + "', Diagnosis = '" + DiagnosisTb.Text + "', Treatment = '" + TreatmentTb.Text + "', Cost = '" + CostTb.Text + "', VetName = '" + VetNameTb.Text + "' where CowId = " + key + "; ";
